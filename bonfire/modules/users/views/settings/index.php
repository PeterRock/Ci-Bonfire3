    ...
    <table class="table table-striped table-responsive">
        ...
        <tr>
            <td colspan="<?php echo $numColumns; ?>">
                ...
                if ($filter_type == 'deleted') :
                    ?>
                    <input type="submit" name="restore" class="btn btn-default"
                           value="<?php echo lang('bf_action_restore'); ?>"/>
                ...
                <?php else : ?>
                    <input type="submit" name="activate" class="btn btn-default"
                           value="<?php echo lang('bf_action_activate'); ?>"/>
                    <input type="submit" name="deactivate" class="btn btn-default"
                           value="<?php echo lang('bf_action_deactivate'); ?>"/>
                    <input type="submit" name="ban" class="btn btn-default"
                           value="<?php echo lang('bf_action_ban'); ?>"/>
        ...
        <?php foreach ($users as $user) : ?>
            <tr>
                ...
                <td class='last-login'><?php echo $user->last_login != NULL ? user_time(strtotime($user->last_login), null, 'M j, y g:i A') : '---'; ?></td>
                <td class='status'>
                    <?php if ($user->active) : ?>
