...
<div class="admin-box">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="submit" class="btn btn-danger"
                               onclick="return confirm('<?php e(js_escape(lang('mb_delete_confirm'))) ?>');"
                               value="<?php e(lang('bf_action_delete')) ?>"/>
                        <?php echo form_close(); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    ...
    <?php else: ?>
        <div class="alert alert-warning">
            <p><?php e(lang('mb_no_modules')); ?> <a
                        href="<?php echo site_url(SITE_AREA . '/developer/builder/create_module') ?>"><?php e(lang('mb_create_link')); ?></a>
            </p>
        </div>
    <?php endif; ?>
</div>