...
<div class="box select admin-box">
    <?php echo form_open(SITE_AREA . "/reports/activities/{$vars['which']}", 'class="form-horizontal constrained"'); ?>
        ...
        <fieldset class="form-actions">
            ...
            ?>
            <button type="submit" name="delete" class="btn btn-danger" id="delete-activity_own"><span class="glyphicon glyphicon-trash glyphicon-white"></span>&nbsp;<?php echo lang('activities_own_delete'); ?></button>
            <?php elseif ($vars['which'] == 'activity_user' && $hasPermissionDeleteUser) : ?>
            <button type="submit" name="delete" class="btn btn-danger" id="delete-activity_user"><span class="glyphicon glyphicon-trash glyphicon-white"></span>&nbsp;<?php echo lang('activities_user_delete'); ?></button>
            <?php elseif ($vars['which'] == 'activity_module' && $hasPermissionDeleteModule) : ?>
            <button type="submit" name="delete" class="btn btn-danger" id="delete-activity_module"><span class="glyphicon glyphicon-trash glyphicon-white"></span>&nbsp;<?php echo lang('activities_module_delete'); ?></button>
            <?php elseif ($vars['which'] == 'activity_date' && $hasPermissionDeleteDate) : ?>
            <button type="submit" name="delete" class="btn btn-danger" id="delete-activity_date"><span class="glyphicon glyphicon-trash glyphicon-white"></span>&nbsp;<?php echo lang('activities_date_delete'); ?></button>
            <?php endif; ?>
        </fieldset>
    <?php echo form_close(); ?>
</div>
...
<div id="user_activities">
    <table class="table table-striped table-bordered" id="flex_table">
        ...
        <tbody>
            ...
            <tr>
                <td><span class="glyphicon glyphicon-user"></span>&nbsp;<?php e($activity->username); ?></td>
