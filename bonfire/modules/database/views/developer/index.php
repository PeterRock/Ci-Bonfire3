    ...
    <?php if (empty($tables) || !is_array($tables)) : ?>
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td colspan="7">
                    <div class="form-inline">
                        <label class="control-label" for='database-action'><?php echo lang('bf_with_selected'); ?>
                            :</label>
            ...
            <?php foreach ($tables as $table) : ?>
                <tr>
                    <td class="column-check"><input type="checkbox" value="<?php e($table->Name); ?>" name="checked[]"/>
                    </td>
                    <td>
