        ...
        <table class="table table-striped">
            ...
            foreach ($backups as $file => $atts) :
                ...
                <tr class="hover-toggle">
                    ...
                    <td>
                        <a href='<?php echo "{$databaseUrl}/get_backup/{$file}"; ?>'><?php e(sprintf(lang('database_link_title_download'), $file)); ?></a>
                    </td>
                    <td>
                        <a href='<?php echo "{$databaseUrl}/restore/{$file}"; ?>'><?php e(sprintf(lang('database_link_title_restore'), $file)); ?></a>
                    </td>
