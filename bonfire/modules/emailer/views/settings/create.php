...
<div class="admin-box">
    ...
    <fieldset>
        <div class='form-group'>
            ...
            <div class='controls'>
                <input type="text" size="50" name="email_subject" id="email_subject" class="form-control"
                       value="<?php if (isset($email_subject)) {
                           e($email_subject);
                       } ?>"/>
            </div>
        </div>
                ...
                <tr>
                    <td class='column-check'>
                        <input type="checkbox" name="checked[]"
                               value="<?php echo $user->id; ?>"<?php echo $hasChecked && in_array($user->id, $checked) ? ' checked="checked"' : ''; ?> />
                    </td>
                    ...
                    <td><?php echo $user->last_login == NULL ? '---' : user_time(strtotime($user->last_login), null, 'M j, y g:i A'); ?></td>
